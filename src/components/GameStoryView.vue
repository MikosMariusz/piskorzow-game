        ...
        >
            ...
            >
                <GameButton
                    ...
                    :class="$vuetify.display.smAndUp ? 'nav-btn' : ''"
                    :label="$vuetify.display.smAndUp ? 'storyView.previousStep' : ''"
                />
                ...
                <GameButton
                    ...
                    :action="() => nextStep()"
                    :class="$vuetify.display.smAndUp ? 'nav-btn' : ''"
                    :label="$vuetify.display.smAndUp ? 'storyView.nextStep' : ''"
...
async function loadConfig() {
    ...
    try {
        ...
        config.value = conf
        const context = isGame.value ? 'game' : 'presentation'
        const key = `gameProgress_${storyId.value}_${context}`
...
const resumeGame = () => {
    ...
    if (step) {
        ...
        setStoryView({ feature: step.feature, features: step.features, view: step.view })
    }
}
